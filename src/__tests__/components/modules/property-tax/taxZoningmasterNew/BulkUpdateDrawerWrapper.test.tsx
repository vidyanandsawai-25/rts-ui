...
vi.mock('next/navigation', () => ({
  useRouter: () => ({ back: backMock, push: vi.fn(), replace: vi.fn(), refresh: vi.fn() }),
}));
...
describe('BulkUpdateDrawerWrapper', () => {
  ...
  it('clicking Apply calls toCreatePayloads then handleBulkApply, and success calls router.back', async () => {
