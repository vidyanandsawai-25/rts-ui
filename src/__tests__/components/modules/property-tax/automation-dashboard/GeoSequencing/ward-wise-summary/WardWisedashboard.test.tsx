    ...
    wardData: [
      {
        ...
        assessmentStatusBreakdown: {
          assessed: { structureCount: 6, unitCount: 12 },
          unassessed: { structureCount: 2, unitCount: 4 },
          newlyAssessedFound: { structureCount: 1, unitCount: 2 },
          assessmentInProcess: { structureCount: 1, unitCount: 2 },
        },
      },
    ],
    totalRow: {
