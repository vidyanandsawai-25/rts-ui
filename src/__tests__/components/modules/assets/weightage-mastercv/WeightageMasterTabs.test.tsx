...
import { WeightageMasterHeader } from '@/components/modules/assets/configuration/master-data/weightage-mastercv/WeightageMasterTabs';
import { WeightageMasterErrorProvider } from '@/components/modules/assets/configuration/master-data/weightage-mastercv/WeightageMasterErrorContext';
...
describe('WeightageMasterHeader', () => {
  ...
  beforeEach(() => {
    mockPush.mockClear();
    mockPathname.mockReturnValue('/en/assets/configuration/master-data/weightage-master');
  });
  ...
  it('sets nature tab as active when on nature-weightage path', () => {
    mockPathname.mockReturnValue('/en/assets/configuration/master-data/weightage-master/nature-weightage');
  ...
  it('sets subType tab as active when on sub-type-weightage path', () => {
    mockPathname.mockReturnValue('/en/assets/configuration/master-data/weightage-master/sub-type-weightage');
  ...
  it('sets age tab as active when on age-weightage path', () => {
    mockPathname.mockReturnValue('/en/assets/configuration/master-data/weightage-master/age-weightage');
  ...
  it('navigates to floor tab (base path) when floor is clicked', () => {
    ...
    expect(mockPush).toHaveBeenCalledWith('/en/assets/configuration/master-data/weightage-master');
  });
  ...
  it('navigates to nature-weightage when nature tab is clicked', () => {
    ...
    expect(mockPush).toHaveBeenCalledWith('/en/assets/configuration/master-data/weightage-master/nature-weightage');
  });
  ...
  it('navigates to sub-type-weightage when subType tab is clicked', () => {
    ...
    expect(mockPush).toHaveBeenCalledWith('/en/assets/configuration/master-data/weightage-master/sub-type-weightage');
  });
  ...
  it('navigates to age-weightage when age tab is clicked', () => {
    ...
    expect(mockPush).toHaveBeenCalledWith('/en/assets/configuration/master-data/weightage-master/age-weightage');
  });
  ...
  it('respects locale in navigation URLs', () => {
    ...
    expect(mockPush).toHaveBeenCalledWith('/np/assets/configuration/master-data/weightage-master/nature-weightage');
  });
  ...
  it('defaults to floor tab for unknown paths', () => {
    mockPathname.mockReturnValue('/en/assets/configuration/master-data/weightage-master/unknown-path');
