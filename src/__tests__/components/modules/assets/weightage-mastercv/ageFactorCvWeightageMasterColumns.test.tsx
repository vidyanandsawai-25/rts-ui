...
import { getAgeFactorCvWeightageMasterColumns } from '@/components/modules/assets/configuration/master-data/weightage-mastercv/ageFactorCv/ageFactorCvWeightageMasterColumns';
