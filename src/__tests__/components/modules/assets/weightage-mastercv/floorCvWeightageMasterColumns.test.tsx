...
import { getFloorCvWeightageMasterColumns } from '@/components/modules/assets/configuration/master-data/weightage-mastercv/floorFactorCv/floorCvWeightageMasterColumns';
