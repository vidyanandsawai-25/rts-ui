...
import { getNatureFactorCvColumns } from '@/components/modules/assets/configuration/master-data/weightage-mastercv/natureFactorCv/natureFactorCvColumns';
import { NatureFactorCVMaster } from '@/types/asset-masters/natureofbuilding-cv-weightageMaster.types';
