...
import { getTypeOfUseColumns, getUseFactorColumns } from '@/components/modules/assets/configuration/master-data/weightage-mastercv/useCategoryCv/useCategoryCvColumns';
import { UseFactorCVMaster, UseType } from '@/types/asset-masters/useCategoryCvFactor.types';
