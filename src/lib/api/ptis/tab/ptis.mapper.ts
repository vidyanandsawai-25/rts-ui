...
export const ptisMapper = {
  ...
  mapSocietyDetails: (data: SocietyDetailsApiResponse): SocietyDetailsData => {
    return {
      ...defaultSocietyDetails,
      buildingSocietyName: data.buildingSocietyName || '',
      buildingSocietyNameMarathi: data.buildingSocietyNameMarathi || '',
      builderName: data.builderName || '',
      builderNameMarathi: data.builderNameMarathi || '',
      landOwner: data.landOwner || '',
      secretaryName: data.secretaryName || '',
      secretaryNameMarathi: data.secretaryNameMarathi || '',
      secretaryMobileNo: data.secretaryMobileNo || '',
      secretaryEmail: data.secretaryEmail || '',
      societyEmail: data.societyEmail || '',
      societyEmailMain: data.societyEmailMain || '',
      ocDate: data.ocDate || '',
      ocNumber: data.ocNumber || '',
      societyAddress: data.societyAddress || '',
      societyAddressMarathi: data.societyAddressMarathi || '',
