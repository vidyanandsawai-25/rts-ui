...
export const mockRtsOfficers: RtsOfficer[] = [
  {
    id: "emp-101",
    name: "Arjun Phadke",
...
export const mockRtsApplications: RtsApplication[] = [
  {
    id: "1001",
...
export const mockRtsModules: ModuleConfig[] = [
  {
    key: "dashboard",
    name: "Dashboard",
    nameMr: "डॅशबोर्ड",
...
export const mockRtsRoles: RoleAccess[] = [
  {
...
export const mockRtsRoleModules = [
