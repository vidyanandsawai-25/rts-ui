// src/lib/mock/rts/departments.ts
import type { SupportedLanguage, I18nText, Service, Department } from "@/types/rts/departments.types";

export type { SupportedLanguage, I18nText, Service, Department };
    ...
    services: [
      ...
      },
      {
        ...
        name: {
          ...
          mr: "व्यवसाय (प्रकार) बदलणे – FIELD TABLE",
        },
        icon: "",
      },
      {
