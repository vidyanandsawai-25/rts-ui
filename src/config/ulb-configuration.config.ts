/**
 * Configuration and constants for the ULB Configuration module.
 * Keep pure data here so UI components stay slim and tree-shake friendly.
 */

import type { Option } from '@/components/common/select';

export const ULB_TYPE_OPTIONS: { label: string; value: number }[] = [
  { label: 'Municipal Corporation', value: 1 },
  { label: 'Municipal Council', value: 2 },
  { label: 'Nagar Panchayat', value: 3 },
  { label: 'Town Panchayat', value: 4 },
  { label: 'Cantonment Board', value: 5 },
];

export const ULB_TYPES: string[] = ULB_TYPE_OPTIONS.map((o) => o.label);
...
export const SUPPORT_TYPES: string[] = [
  'Email Support',
  'Phone Support',
  'Email + Phone Support',
...
export const LICENSE_DURATION_OPTIONS: Option[] = [
  ...
  { value: '999', label: 'Perpetual' },
  { value: 'custom', label: 'Custom...' },
];

export const DEPARTMENT_DURATION_OPTIONS: Option[] = [
  { value: '1', label: '1 Month' },
  { value: '3', label: '3 Months' },
  { value: '6', label: '6 Months' },
  { value: '12', label: '1 Year' },
...
export const FONT_OPTIONS: string[] = ['Inter', 'Poppins', 'Roboto', 'Montserrat', 'Lato', 'Outfit'];

/**
 * Static Indian state/district reference lists for ULB location fields.
 * Replace with API-driven State/District master data when the backend exposes it.
 */
...
export function toOptions<T extends string | number>(values: readonly T[]): Option[] {
...
export const IMAGE_CONSTRAINTS = {
  ...
  ALLOWED_FORMATS: ['image/jpeg', 'image/png', 'image/webp', 'image/svg+xml'],
} as const;
