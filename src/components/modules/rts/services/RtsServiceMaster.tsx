...
export function RtsServiceMaster({
  ...
  const t = useTranslations('rts.masters');
  ...
  const handleDeleteClick = useCallback(
    (row: RtsServiceApiItem) => {
      confirm({
        ...
        description:
          'Are you sure you want to delete this RTS Service? All dynamic fields for this service will also be dereferenced.',
        onConfirm: async () => {
  ...
  return (
    <PageContainer>
      <div className="space-y-4">
        <TableHeader
          title={t('registeredServicesMaster')}
          subtitle={t('serviceMasterSubtitle')}
          icon={Sparkles}
