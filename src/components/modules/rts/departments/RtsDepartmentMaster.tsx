  ...
  const handleDeleteClick = useCallback(
    (row: RtsDepartmentApiItem) => {
      confirm({
        ...
        description:
          'Are you sure you want to delete this RTS Department? This action cannot be undone.',
        onConfirm: async () => {
  ...
  return (
    <PageContainer>
      <div className="space-y-4">
        <TableHeader
          title={t('registeredDepartmentsMaster')}
          subtitle={t('departmentMasterSubtitle')}
          icon={Building2}
          actionLabel={t('addDept')}
