...
import { ImageHoverPreviewProps } from '@/types/asset/asset-register/media.types';
...
export function ImageHoverPreview({
  ...
  return (
    <div
      ...
      className="
        hidden lg:block
        absolute right-full top-[-48px] pr-4 z-50
    ...
    >
      <div className="w-[480px] h-full rounded-2xl overflow-hidden shadow-2xl border-[3px] border-blue-600 bg-white relative select-none">
        <div
          className={`w-full h-full relative overflow-hidden bg-white ${zoomScale > 1 ? (isDragging ? 'cursor-grabbing' : 'cursor-grab') : 'cursor-zoom-in'
            }`}
          style={{
