    ...
    <PageContainer>
      <div className="space-y-4">
        <TableHeader
          ...
          actionLabel={t("add")}
          onActionClick={() => {
            router.push(`/${locale}/assets/configuration/master-data/gst-master/add`);
          }}
          rightContent={
            <div className="flex w-full justify-end">
              <SearchInput
                ...
                placeholder={t("searchPlaceholder") || "Search GST records..."}
        ...
        <MasterTable<GstMaster>
          ...
          renderActions={(row) => (
            <>
              <EditButton aria-label={t("edit")} onClick={() => router.push(`/${locale}/assets/configuration/master-data/gst-master/edit/${row.id}`)} />
