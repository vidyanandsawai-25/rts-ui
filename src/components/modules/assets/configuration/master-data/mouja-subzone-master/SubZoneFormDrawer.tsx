...
import { SubZoneFormFields } from "./SubZoneFormFields";

export interface SubZoneFormDrawerProps {
  id: number | null;
...
export default function SubZoneFormDrawer({
  id,
  initialData,
  selectedMoujaId,
  moujas,
  ...
  const moujaOptions = moujas.map((m) => ({
    label: m.moujaName,
    value: String(m.id),
  }));
  ...
  return (
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-lg font-bold text-blue-900">
              {isEdit ? t("form.editSubZoneTitle") : t("form.addSubZoneTitle")}
            </div>
    ...
    >
      <form id="subzone-form" onSubmit={handleSubmit} className="space-y-6 bg-[#F8FAFF] p-5">
        {isEdit && (
