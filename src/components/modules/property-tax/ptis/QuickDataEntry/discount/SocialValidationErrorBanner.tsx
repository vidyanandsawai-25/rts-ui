...
interface IncompleteAttribute {
    id: number;
    name: string;
    code?: string;
}

interface SocialValidationErrorBannerProps {
...
export const SocialValidationErrorBanner: React.FC<SocialValidationErrorBannerProps> = ({
    incompleteAttributes,
    onTagClick,
    t,
}) => {
    if (incompleteAttributes.length === 0) return null;
