  ...
  const newColumns: Column<MappedFloorDetail>[] = [
    {
      ...
      render: (val: any) => (
        <div className="border border-gray-300/60 rounded bg-white py-0.5 px-1.5 text-left">{val}</div>
      )
    },
    {
      key: 'conYear',
    ...
    },
    {
      ...
      render: (_, row: MappedFloorDetail) => (
        <div className="border border-gray-300/60 rounded bg-white py-0.5 px-1.5 text-left">
    ...
    },
    {
      ...
      render: (val: unknown) => (
        <div className="border border-gray-300/60 rounded bg-white py-0.5 px-1.5 text-left">{formatTaxLiability(val)}</div>
      )
    },
    {
      key: 'rentMy',
    ...
    },
    {
      ...
      render: (val: unknown) => (
        <div className="border border-gray-300/60 rounded bg-white py-0.5 px-1.5 text-left">{formatNumberish(val)}</div>
      )
    },
    {
      key: 'depreciation',
