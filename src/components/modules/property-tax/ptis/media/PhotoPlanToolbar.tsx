...
export function PhotoPlanToolbar({
  ...
  return (
    <div className="h-16 bg-white border-t border-slate-200 flex items-center justify-between px-3 sm:px-6 z-10 flex-shrink-0 gap-2">
      <div className="flex flex-col min-w-0">
        <div className="flex items-center gap-1.5 min-w-0">
          <span className="text-slate-800 text-xs font-semibold truncate block">{title}</span>
        </div>
      ...
      <div className="flex items-center gap-1 sm:gap-2">
        ...
        >
          <span className="hidden sm:inline">{t('media.rotateLeft')}</span>
        </Button>
        <Button
          variant="secondary"
          size="xs"
        ...
        >
          <span className="hidden sm:inline">{t('media.rotateRight')}</span>
        </Button>
        <Button
          variant="secondary"
          size="xs"
        ...
        >
          <span className="hidden sm:inline">{t('media.reset')}</span>
        </Button>
        ...
        {hasImage ? (
          <>
            ...
            >
              <span className="hidden sm:inline">{t('media.replaceImage')}</span>
            </Button>
            <Button
              variant="primary"
              size="xs"
          ...
          >
            <span className="hidden sm:inline">{t('media.uploadImage')}</span>
          </Button>
        )}
      </div>
    </div>
