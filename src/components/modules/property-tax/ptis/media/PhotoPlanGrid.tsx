        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 pb-8">
          {images.map((img, index) => (
            <div
              ...
              className="relative group bg-white rounded-lg overflow-hidden border border-slate-200 shadow-sm hover:shadow-md hover:border-blue-400 transition-all cursor-pointer h-40 flex flex-col"
            >
