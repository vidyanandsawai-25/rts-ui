        ...
        {initialLoading ? (
          ...
          <div className="space-y-3 p-3">
            ...
            <div className="grid grid-cols-4 gap-2">
              {[
                { label: t("stats.totalConnections"), value: stats.totalConnections, bgClass: "bg-blue-50 border-blue-100", textClass: "text-blue-700" },
                { label: t("stats.activeConnections"), value: stats.activeConnections, bgClass: "bg-green-50 border-green-100", textClass: "text-green-700" },
                { label: t("stats.stoppedConnections"), value: stats.stoppedConnections, bgClass: "bg-orange-50 border-orange-100", textClass: "text-orange-700" },
                { label: t("stats.yearlyRevenue"), value: `₹${stats.yearlyRevenue.toLocaleString("en-IN", { maximumFractionDigits: 0 })}`, bgClass: "bg-purple-50 border-purple-100", textClass: "text-purple-700" },
