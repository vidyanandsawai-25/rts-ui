...
import { Building, Layers, Search } from "lucide-react";
import {
  Card,
  CardHeader,
  CardTitle,
...
export function PropertySelectionCard({
  ...
  return (
    <Card className="rounded-xl shadow-sm border border-slate-200/80 overflow-visible h-full flex flex-col gap-4 ">
