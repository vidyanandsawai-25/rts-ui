...
export const SEARCH_BRAND_ACTIVE_TAB =
  "!rounded-t !rounded-b-none !border-0 !bg-[#004c8c] !text-white !shadow-sm relative z-10";

export const SEARCH_BRAND_BUTTON =
  "!bg-[#004c8c] !text-white hover:!bg-[#003d6f] !border-[#004c8c] hover:!border-[#003d6f] shadow-sm hover:shadow-md transition-all duration-200";

export const SEARCH_RESET_BUTTON =
  "!bg-[#e87524] !text-white hover:!bg-[#cf6314] !border-[#e87524] hover:!border-[#cf6314] shadow-sm hover:shadow-md transition-all duration-200";
