...
import { updateUseFactorCVMasterAction, createUseFactorCVMasterAction } from "@/app/[locale]/assets/configuration/master-data/weightage-master/sub-type-weightage/action";
