 ...
 *    - Remove the `onKeyDown={handleKeyDown}` prop from the main wrapper/form elements.
 *    - (For `Propertybasicform.tsx` remove `handleKeyDown` from the destructured variables of `usePropertyBasicForm` and the `onKeyDown` prop).
 */
