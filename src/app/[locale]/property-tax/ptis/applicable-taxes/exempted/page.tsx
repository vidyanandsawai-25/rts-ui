...
import { getAssessmentYearsAction, getUseGroupsAction, getTaxApplicabilityAction } from '../action';
...
export default async function ExemptedPage({ params, searchParams }: PageProps) {
  ...
  const financialYearId = selectedAsseYear ? Number(selectedAsseYear) : undefined;
