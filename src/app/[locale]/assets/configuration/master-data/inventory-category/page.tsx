...
import {
  ...
  InventoryCategoryMasterErrorProvider,
  InventoryCategoryMasterLayoutContent
} from "@/components/modules/assets/configuration/master-data/inventory-category-master";
...
export default async function Page({ params, searchParams }: PageProps): Promise<React.ReactElement> {
  ...
  if (!result.success) {
    throw new Error(result.error || "Failed to load inventory category master data");
  }
